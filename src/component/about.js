...
function About() {
    ...
    return(
      <>
            ...
            <MDBContainer fluid className='aboutrow2'>
               <MDBContainer>
                ...
                <h1 className='About_main_topic' data-aos="fade-up" data-aos-once="true"> WHAT I <span style={{color:"rgba(0, 153, 255, 0.767)"}}>DO</span>...</h1>
                
                <MDBContainer>
                    <MDBRow className='d-flex justify-content-center'>
                        <MDBCol lg='4' md='6' sm='12' className='d-flex justify-content-center' data-aos="fade-up" data-aos-once="true">
                        ...
                        <MDBCol lg='4' md='6' sm='12' className='d-flex justify-content-center' data-aos="fade-down" data-aos-once="true">
                ...
                <MDBContainer fluid style={{padding:'0%'}}>
                    <MDBRow className='About_img_row' data-aos="fade-up" data-aos-once="true" >
                        <img src={tech} alt='used technolgies'></img>
                    </MDBRow>
                </MDBContainer>

                <h1 className='About_main_topic' data-aos="fade-up" data-aos-once="true"> OTHER SKILLS <span style={{color:"rgba(0, 153, 255, 0.767)"}}>AND</span> TALENTS</h1>
     ...
     {/*//////////////mobile view/////////////*/}
            ...
            <h1 className='About_main_topic' style={{paddingBottom:'0%'}} data-aos="fade-up" data-aos-once="true"> WHAT <span style={{color:"rgba(0, 153, 255, 0.767)"}}>PEOPLE</span> SAY</h1>
            <div className='d-flex justify-content-center' data-aos="fade-up" data-aos-once="true">
                  <button className='contact_btn mx-auto'>Give Feedback</button>
            </div>
            <MDBContainer style={{marginTop:'50px',marginBottom:'150px'}} data-aos="fade-up" data-aos-once="true">
                 <DemoCarousel/>
            </MDBContainer>
